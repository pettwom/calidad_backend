...
const saveValidar = async (req, res) => {
  ...
  var obs_id_qwery = req.body.obs? `and obs_observacion = '${req.body.obs}'`:'';
  if (tipoRep == 1) {
    tipo = "CUESTIONARIO";
  } else {
    tipo = "PREGUNTA";
  ...
  console.log(` 
          ...
          WHERE tipo = 'PREGUNTA' AND rep_id = ${ids} ${preg_qwery}  ${obs_id_qwery} ${pre_id}
  ...
  if (tipoRep == 1) {
    switch (estado) { 
      ...
      case 7:
        ...
        // console.log(estadoCuestionario.rowCount>0  );
        // console.log(pendiente.length >0  );
        // console.log(pendiente.length ,'cantidad pendiente');
  ...
  console.log('Registro ==>',insertarRegistro)
...
group by ao.obs_id,ao.pre_id, ao.pre_num_pregunta,ae.descripcion ,ao.obs_justificacion,ao.obs_observacion, ao.res_val, ao.res_cosecha, ao.estado_id, ao.obs_id_mod
order by 1,2,3,5`;
