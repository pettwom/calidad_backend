...
const getListadoCuest = async (req, res) => {
  ...
  var query = `select row_number() over(order by ca.depto)nro,ca.depto, ca.mpio,ae2.ag_unico, 
              ...
              join marco_area.areas_enumeradas ae2 on ae2.ae_unico = ar.rep_ae 
...
const getAlertas = async(req, res) => {
  ...
  var getPreg = await con.query(`select distinct cv.pre_numero_pregunta  from calidad.cal_validaciones cv where cv.pre_numero_pregunta not in( 16,18,29) order by 1`)
